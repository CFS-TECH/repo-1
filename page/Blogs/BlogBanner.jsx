...
const BlogBanner = () => {
  ...
  return (
    <section className="relative w-full min-h-[300px] flex items-center justify-center overflow-hidden  bg-black">
      ...
      >
        {/* Title */}
        <motion.h1 variants={fadeInUp} className="text-4xl md:text-2
        xl font-extrabold mb-4 tracking-tight leading-tight">
        ...
        <motion.div variants={fadeInUp} className="relative max-w-2xl mx-auto my-6 group ">
          ...
          <input
            ...
            className="w-full bg-white/5 backdrop-blur-xl border border-white/5 py-2 pl-8 pr-20 rounded-full text-white placeholder-zinc-500 focus:outline-none focus:ring-1 focus:ring-orange-500/80 transition-all text-lg shadow-2xl"
          />
          <motion.button
