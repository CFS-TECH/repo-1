...
export const ServicesBanner = () => {
  ...
  return (
    <section className="w-full min-h-[90vh] md:min-h-[600px] md:h-[80vh] relative overflow-hidden font-sans">
      {/* Background Image */}
      <motion.img
        initial={{ scale: 1.2 }}
        animate={{ scale: 1 }}
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center h-full pt-24 md:pt-0 text-white z-40">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="flex items-start">
                <Link href={"/contact"}>
                  <button className="group relative overflow-hidden flex items-center bg-[#ff6b00] text-white font-bold py-3 px-6 md:py-4 md:px-8 rounded-xl transition-all duration-300 hover:bg-[#e65c00] shadow-xl">
