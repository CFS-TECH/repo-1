...
import { FaGamepad } from "react-icons/fa"; // Changed icon to Gamepad
    ...
    <div>
      <section className="relative w-full flex items-center justify-center flex-col bg-gradient-to-b from-orange-50/50 to-white px-4 py-10 md:py-12 overflow-hidden">
        ...
        >
          ...
          >
            <button className="w-full cursor-pointer sm:w-auto bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-2.5 text-sm md:text-base rounded-full font-semibold shadow-md hover:shadow-orange-500/40 hover:-translate-y-0.5 transition-all duration-300">
              Start Your Project
            </button>
            <button className="w-full cursor-pointer sm:w-auto bg-white border border-orange-200 text-orange-600 px-6 py-2.5 text-sm md:text-base rounded-full font-semibold shadow-sm hover:border-orange-500 hover:bg-orange-50 hover:-translate-y-0.5 transition-all duration-300">
              View Our Work
            </button>
          </motion.div>
        </motion.div>
